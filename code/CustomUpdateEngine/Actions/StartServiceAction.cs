...
{
   public class StartServiceAction : GenericAction
    {
        public StartServiceAction(string xmlFragment)
        {
        ...
        {
            Logger.Write("Running StartServiceAction. ServiceName = " + this.ServiceName);
                ...
                if (query != null)
                {
                    ...
                    foreach (ManagementObject service in services)
                    {
                        ...
                        if (resultCode == 0)
                            ...
                            Logger.Write("Failed to start " + ServiceName + ". Result code = " + resultCode + " : " + this.GetResultCodeMeaning(resultCode));
                    }
                }
                else
            ...
            {
                Logger.Write("Failed start " + ServiceName + "\r\n" + ex.Message);
            }
            Logger.Write("End of StartServiceAction.");
        }

...
{
    public partial class RegisterDLLAction : GenericAction
    {
        public RegisterDLLAction()
            : base()
        {
            InitializeComponent();
            this.ExpandedHeigth = 130;
            this.ActionIcon = Properties.Resources.RegisterDLL;
            this.Text = GetLocalizedString("DescriptionRegisterDLLAction");
        }

        #region Properties

        /// <summary>
        /// Gets or Sets the full path to the DLL file.
        /// </summary>
        ...
        {
            return this.GetLocalizedString("RegisterDLL") + this.FullPath;
        }

...
{
    public partial class RenameRegKeyAction : GenericAction
    {
        public RenameRegKeyAction():base()
        {
            InitializeComponent();
            this.ExpandedHeigth = 230;
            this.ActionIcon = Properties.Resources.RenameRegistryKeyElement;
            this.Text = GetLocalizedString("DescriptionRenameRegKeyAction");
        ...
        /// <summary>
        /// Gets or Sets the registry Hive where to rename the Registry key.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets the name of the Registry Key to rename.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets the new name of the Registry Key.
        /// </summary>
        /// <exception cref="NullReferenceException">'RegKey' can not be set to null.</exception>
        ...
        private void ValidateData()
        {
            ...
            if (!regKeyOK || !newNameOK || this.cmbBxHive.SelectedItem == null || this.cmbBxHive.SelectedIndex == -1)
        ...
        {
            return this.GetLocalizedString("RenameThisRegKey") + this.Hive.ToString() + "\\" + this.RegKey + this.GetLocalizedString("Into") + this.NewName;
        }

...
{
    public partial class RunVbScriptAction : GenericAction, IStoreReturnCodeToVariable
    {
        public RunVbScriptAction():base()
        {
            InitializeComponent();
            this.ExpandedHeigth = 200;
            this.ActionIcon = Properties.Resources.VbScriptElement;
            this.Text = GetLocalizedString("DescriptionRunVBScriptAction");
        }
        ...
        protected override string GetConfiguratedDescription()
        {
            ...
            result = this.GetLocalizedString("ExecuteTheVbScript") + this.FullPath;

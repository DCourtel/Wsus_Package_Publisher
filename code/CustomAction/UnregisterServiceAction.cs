...
{
    public partial class UnregisterServiceAction : GenericAction
    {
        public UnregisterServiceAction()
            : base()
        {
            InitializeComponent();
            this.ExpandedHeigth = 120;
            this.ActionIcon = Properties.Resources.UnregisterServicesElement;
            this.Text = GetLocalizedString("DescriptionUnregisterServiceAction");
        }
        ...
        {
            return this.GetLocalizedString("UnregisterTheService") + this.ServiceName + ".";
        }

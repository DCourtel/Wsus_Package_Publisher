...
{
    public partial class StopServiceAction : GenericAction
    {
            ...
            : base()
        {
            ...
            this.ActionIcon = Properties.Resources.StopServicesElement;
            this.Text = GetLocalizedString("DescriptionStopServiceAction");
        }
        ...
        {
            return this.GetLocalizedString("StopTheService") + this.ServiceName + ".";
        }

...
{
    public partial class RebootAction : GenericAction
    {
        public RebootAction()
            : base()
        {
            ...
            this.ActionIcon = Properties.Resources.Reboot;
            this.Text = GetLocalizedString("DescriptionRebootAction");
        ...
        {
            return this.GetLocalizedString("Reboot");
        }

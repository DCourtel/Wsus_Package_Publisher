...
{
    public partial class ImportRegFileAction : GenericAction
    {
        public ImportRegFileAction()
            : base()
        {
            InitializeComponent();
            this.ExpandedHeigth = 130;
            this.ActionIcon = Properties.Resources.MergeRegFile;
            this.Text = GetLocalizedString("DescriptionImportRegFileAction");
        }

        #region Properties

        /// <summary>
        /// Gets or Sets the full path to the file to import.
        /// </summary>
        ...
        public string FullPath
        {
            ...
            set { this.txtBxFullPath.Text = value.Trim(); }
        }
        ...
        {
            return this.GetLocalizedString("ImportTheFile") + this.FullPath + ".";
        }

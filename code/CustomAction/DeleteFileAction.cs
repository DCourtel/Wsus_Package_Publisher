...
{
    public partial class DeleteFileAction : GenericAction
    {
            ...
            : base()
        {
            ...
            this.ActionIcon = Properties.Resources.DeleteFileElement;
            this.Text = GetLocalizedString("DescriptionDeleteFileAction");
        }

        #region Properties

        /// <summary>
        /// Gets or Sets the full path to the file to delete.
        /// </summary>
        ...
        {
            return this.GetLocalizedString("DeleteTheFile") + this.FullPath + ".";
        }

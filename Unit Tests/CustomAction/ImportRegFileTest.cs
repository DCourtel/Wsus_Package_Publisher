...
namespace Unit_Tests_CustomAction
{
    ...
    ///</summary>
    [TestClass()]
    public class ImportRegFileActionTest
    {
        ...
        ///</summary>
        [TestMethod()]
        public void ImportRegFileActionConstructorTest()
        {
            ImportRegFileAction target = new ImportRegFileAction();
        ...
        public void GetXMLActionTest()
        {
            ...
            string expected = "<Action>\r\n<ElementType>CustomActions.ImportRegFileAction</ElementType>\r\n<FullPath>" + target.FullPath + "</FullPath>\r\n</Action>";
            string actual;

...
namespace Unit_Tests_CustomAction
{
    ...
    ///</summary>
    [TestClass()]
    public class RegisterDLLActionTest
    {
        ...
        ///</summary>
        [TestMethod()]
        public void RegisterDLLActionConstructorTest()
        {
            RegisterDLLAction target = new RegisterDLLAction();
        ...
        public void GetXMLActionTest()
        {
            ...
            string expected = "<Action>\r\n<ElementType>CustomActions.RegisterDLLAction</ElementType>\r\n<FullPath>" + target.FullPath + "</FullPath>\r\n</Action>";
            string actual;

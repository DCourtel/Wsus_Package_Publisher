...
{
    /// <summary>
    ///Classe de test pour UnregisterServiceActionTest, destinée à contenir tous
    ///les tests unitaires UnregisterServiceActionTest
    ///</summary>
    [TestClass()]
    public class UnregisterServiceActionTest
    {
        ...
        /// <summary>
        ///Test pour Constructeur UnregisterServiceAction
        ///</summary>
        [TestMethod()]
        public void UnregisterServiceActionConstructorTest()
        {
            UnregisterServiceAction target = new UnregisterServiceAction();
        ...
        public void GetXMLActionTest()
        {
            ...
            string expected = "<Action>\r\n<ElementType>CustomActions.UnregisterServiceAction</ElementType>\r\n<ServiceName>" + target.ServiceName + "</ServiceName>\r\n</Action>";
            string actual;

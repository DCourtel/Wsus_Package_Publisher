...
namespace Unit_Tests_CustomAction
{
    ...
    ///</summary>
    [TestClass()]
    public class ChangeRegDataActionTest
    {
        ...
        [TestMethod()]
        public void ChangeRegDataActionConstructorTest()
        {
            ...
            Assert.AreEqual(String.Empty, target.RegValue, "The property 'RegValue' is not properly initialized");
            Assert.AreEqual(String.Empty, target.NewData, "The property 'NewData' is not properly initialized");
        }
        ...
        public void GetXMLActionTest()
        {
            ...
            target.RegValue = "DisplayVersion";
            target.NewData = "15.0.0.236";
        ...
        public void ValidateDataTest()
        {
            ...
            target.RegKey = @"SOFTWARE\JavaSoft";
            Assert.IsTrue(target.ConfigurationState == GenericAction.ConfigurationStates.Configured, "The property 'ConfigurationState' is not properly updated");
            target.RegValue = String.Empty;
            Assert.IsTrue(target.ConfigurationState == GenericAction.ConfigurationStates.Misconfigured, "The property 'ConfigurationState' doesn't revert back to Misconfigured");
            target.RegValue = "DisplayVersion";
            Assert.IsTrue(target.ConfigurationState == GenericAction.ConfigurationStates.Configured, "The property 'ConfigurationState' is not properly updated");
            target.NewData = String.Empty;
            Assert.IsTrue(target.ConfigurationState == GenericAction.ConfigurationStates.Misconfigured, "The property 'ConfigurationState' doesn't revert back to Misconfigured");
            target.NewData = "15.0.0.236";
            Assert.IsTrue(target.ConfigurationState == GenericAction.ConfigurationStates.Configured, "The property 'ConfigurationState' is not properly updated");
        }
        ...
        public void RegValueTest()
        {
            ...
            target.RegValue = expected;
            actual = target.RegValue;
            Assert.AreEqual(expected, actual, "The property 'RegValue' is not properly updated");
        }
        ...
        [TestMethod()]
        [ExpectedException(typeof(NullReferenceException), "The property 'RegValue' can be set to null")]
        public void RegValueToNullText()
        {
            ChangeRegDataAction target = new ChangeRegDataAction();
            target.RegValue = null;
        }

        [TestMethod()]
        [ExpectedException(typeof(NullReferenceException), "The property 'NewData' can be set to null")]
        public void NewDataToNullText()
        {
            ChangeRegDataAction target = new ChangeRegDataAction();
            target.NewData = null;
        }
